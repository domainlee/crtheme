...
class OneClickDemoImport {
	...
	public function admin_enqueue_scripts( $hook ) {
		...
		if ( $this->plugin_page === $hook || ( 'admin.php' === $hook && $this->plugin_page_setup['menu_slug'] === esc_attr( $_GET['import'] ) ) ) {
			wp_enqueue_script( 'ocdi-main-js', get_template_directory_uri() . '/inc/ocdi/assets/js/main.js' , array( 'jquery' ), OCDI_VERSION );
			...
			wp_enqueue_style( 'ocdi-main-css', get_template_directory_uri() . '/inc/ocdi/assets/css/main.css', array() , OCDI_VERSION );
		}
	}
