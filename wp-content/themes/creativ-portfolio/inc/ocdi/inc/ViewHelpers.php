	...
	public static function plugin_header_output() {
		...
		<div class="ocdi__title-container">
			...
			<a href="https://ocdi.com/user-guide/" target="_blank" rel="noopener noreferrer">
				<img class="ocdi__title-container-icon" src="<?php echo esc_url( get_template_directory_uri() . '/inc/ocdi/assets/images/icons/question-circle.svg' ); ?>" alt="<?php esc_attr_e( 'Questionmark icon', 'one-click-demo-import' ); ?>">
			</a>
		</div>
		<?php
